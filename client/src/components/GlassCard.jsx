...
export default function GlassCard({ children, className = '', glowColor = 'rgba(0, 102, 204, 0.25)', onClick }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        background: isHovered 
          ? `radial-gradient(circle at ${coords.x}px ${coords.y}px, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.04) 50%, rgba(255, 255, 255, 0.01) 100%)`
    ...
    >
      ...
      <div 
        className="relative bg-dark-900/90 backdrop-blur-xl w-full h-full rounded-2xl p-6 overflow-hidden"
        style={{
          background: 'radial-gradient(circle at 50% 0%, rgba(255,255,255,0.03) 0%, transparent 100%), #0a0a0a'
        }}
      >
        ...
        {/* Diagonal high-luxury hairline reflection */}
